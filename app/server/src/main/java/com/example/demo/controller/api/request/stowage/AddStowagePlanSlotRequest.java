...
public class AddStowagePlanSlotRequest {
...
//    @JsonProperty("type")
//    @NotBlank(message = "bay type must not be empty")
//    @Pattern(regexp = BayType.REGEX_PATTERN, message = "type must be D for deck or H for hold")
//    private String type;
