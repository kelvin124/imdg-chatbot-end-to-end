...
public class HoldSnapshotDto {
    ...
    @JsonProperty("cellSnapshots")
    private List<CellSnapshotDto> cellSnapshotDtoList;
    ...
    public List<CellSnapshotDto> getCellSnapshotDtoList() {
        return cellSnapshotDtoList;
    }

    public void setCellSnapshotDtoList(List<CellSnapshotDto> cellSnapshotDtoList) {
        this.cellSnapshotDtoList = cellSnapshotDtoList;
    }
